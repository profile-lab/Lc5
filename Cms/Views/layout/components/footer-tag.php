...
<script src="<?= '/assets/lc/js/jquery.dm-uploader.min.js' ?>"></script>
<script src="<?= '/assets/lc/js/selectize.min.js' ?>"></script>
<script src="<?= '/assets/lc/js/script.js' ?>"></script>
<script src="<?= '/assets/lc/js/pf-script.js' ?>"?v=11-32></script>
<script>
