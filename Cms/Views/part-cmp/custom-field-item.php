...
<div class="custom_field-row_item">
    <?php if ($keys_source  && is_array($keys_source) && count($keys_source) > 0) { ?>
        <?= view('Lc5\Cms\Views\form-cmp/select', ['item' => ['label' => 'Chiave', 'name' => 'custom_field_key', 'input_class' => 'custom_field_key', 'value' => (isset($key)) ? $key : '', 'width' => 'col-md-12', 'sources' => $keys_source]]) ?>
    <?php } else { ?>
