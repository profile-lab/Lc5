                    ...
                    <div id="scheda_tools">
                        <div class="container-fluid">
                            <div class="d-md-flex justify-content-between align-items-center">
                                ...
                                <button type="button" meta-rel-source-id="blocco_columns_par_code" meta-rel-trg="rows_cnt" class="btn btn-sm btn-primary add_colonne add_row"><span class="oi oi-plus"></span><span class="oi oi-image d-sm-none"></span><span class="d-none d-sm-inline">Blocchi</span></button>
